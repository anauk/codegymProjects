...
/*
Учитывая строку str, создайте словарь слов, который он содержит.
Слова в словаре должны быть расположены в лексикографическом порядке.
Найдите частоту каждого слова.
 */
public class Dictionary {
    ...
    public static void main(String[] args) {
        ...
        Scanner in = new Scanner("a la guerre comme a la guerre");
